...
#let interests(interests) = {
  section-header(title: "研究兴趣", icon: "./icons/focus.png")
  set text(1.05em)
...
#let jr_publications(me, publications) = {
  section-header(title: "科研论文", icon: "./icons/jr_pub.png")
  set text(1.05em)
...
#let h_projects(projects) = {
  section-header(title: "横向课题", icon: "./icons/project.svg")
...
#let projects(projects) = {
  section-header(title: "个人项目", icon: "./icons/project.svg")
